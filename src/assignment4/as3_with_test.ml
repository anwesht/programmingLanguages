...
(** Declaration of DataTypes for the language DiMLazy. *)
datatype typ = Bool | Int | Arrow of typ * typ;

(** Declaration of  expr types for the language DiMLazy. *)
...
val ifExp = IfExpr(LessExpr(VarExpr("a"), IntExpr(5)), PlusExpr(VarExpr("a"), IntExpr(10)), PlusExpr(IntExpr(5), IntExpr(10)));
...
val funExp1 = FunExpr("f", "a", Int, Int, ifSimple);
